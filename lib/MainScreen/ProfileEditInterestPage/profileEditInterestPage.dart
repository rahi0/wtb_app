...
import 'package:chatapp_new/Forms/ProfileInterestEditForm/profileInterestEditForm.dart';
...
class ProfileInterestEditPage extends StatefulWidget {
  ...
  ProfileInterestEditPage(this.userData);
  @override
  State<StatefulWidget> createState() {
    return ProfileInterestEditPageState();
  }
}

class ProfileInterestEditPageState extends State<ProfileInterestEditPage> {
  int count = 0, tnc = 0;
          ...
          child: Container(
            child: Column(
              children: <Widget>[
                ...
                InterestEditForm(widget.userData)
              ],
            ),
          ),
        ),
