...
class ShopProductLandCard extends StatefulWidget {
  var productList;
  ShopProductLandCard(this.productList);
  @override
  _ShopProductLandCardState createState() => _ShopProductLandCardState();
}

class _ShopProductLandCardState extends State<ShopProductLandCard> {
  String img = "";
