...
class EFeedStatusEditFormState extends State<FeedStatusEditForm> {
  ...
  void initState() {
    ...
    interests = widget.feed.interest;
    postController.text = widget.feed.status;
    status = widget.feed.privacy;
    for (int j = 0; j < widget.feed.images.length; j++) {
      statusPic = widget.feed.images[j].thum;
      print(statusPic);
      int id = widget.feed.images[j].id;
      //print(id);
                    ...
                    return GestureDetector(
                        onTap: () {
                          setState(() {
                            ...
                            widget.feed.images.removeAt(index);
                            print(images.length);
                          });
                        },
                        child: Container(
